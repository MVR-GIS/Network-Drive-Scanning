...
.DESCRIPTION
    Scans the \\mvd.ds.usace.army.mil\mvr\EGIS\ drive using the Network Drive Scanner Module.
...
# Configuration
$drivePath = "\\mvd.ds.usace.army.mil\mvr\EGIS\"
$drivePrefix = "EGIS"
...
Write-Host "EGIS Drive Scanner" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
